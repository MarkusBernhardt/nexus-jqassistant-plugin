...
@Named
@EagerSingleton
public class FrontendPlugin extends PluginIdentity {

	/**
	 * Prefix for ID-like things.
	 */
	@NonNls
	public static final String ID_PREFIX = "jqassistant-frontend";
	 ...
	 * @throws Exception
	 */
	public FrontendPlugin() throws Exception {
	...
	protected static String loadBundleProperty(String propertyName) {
		try {
			return ResourceBundle.getBundle(FrontendPlugin.class.getCanonicalName().replace(".", File.separator)).getString(propertyName);
